...
.method private final process(Lio/ktor/network/selector/LockFreeMPSCQueue;Ljava/nio/channels/Selector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, p3, v8}, Lio/ktor/network/selector/ActorSelectorManager;->handleSelectedKeys(Ljava/util/Set;Ljava/util/Set;)V
    ...
    .line 73
    invoke-virtual {v2, p2, p3}, Lio/ktor/network/selector/ActorSelectorManager;->applyInterest(Ljava/nio/channels/Selector;Lio/ktor/network/selector/Selectable;)V
    ...
    .line 84
    invoke-virtual {v2, p3}, Lio/ktor/network/selector/ActorSelectorManager;->setCancelled(I)V
...
.method private final receiveOrNullSuspend(Lio/ktor/network/selector/LockFreeMPSCQueue;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 163
    iget-object v5, v2, Lio/ktor/network/selector/ActorSelectorManager;->continuation:Lio/ktor/network/selector/ActorSelectorManager$ContinuationHolder;
    ...
    iget-boolean v6, v2, Lio/ktor/network/selector/ActorSelectorManager;->closed:Z

    if-nez v6, :cond_9

    .line 207
    invoke-static {v5}, Lio/ktor/network/selector/ActorSelectorManager$ContinuationHolder;->access$getRef$p(Lio/ktor/network/selector/ActorSelectorManager$ContinuationHolder;)Ljava/util/concurrent/atomic/AtomicReference;

    move-result-object v6

    invoke-static {v6, v4, p2}, Landroidx/lifecycle/LifecycleKt$$ExternalSyntheticBackportWithForwarding0;->m(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v5, p2, v4}, Landroidx/lifecycle/LifecycleKt$$ExternalSyntheticBackportWithForwarding0;->m(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
